        ...
        <section>
            <div className="py-24">
                <div className="mx-auto w-full max-w-5xl px-6">
                    <div>
                        <h2 className="text-foreground max-w-2xl text-balance text-4xl font-semibold">Crafted for Devs</h2>
                    </div>
                    <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">Quick notes</h3>
                            <p className="text-muted-foreground mt-3 text-balance">Capture your ideas instantly.</p>
                        ...
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">Dev friendly</h3>
                            <p className="text-muted-foreground mt-3 text-balance">Markdown, code blocks and CLI shortcuts</p>
                        ...
                        <Card
                            ...
                            <h3 className="text-foreground mt-5 text-lg font-semibold">Secure by Design</h3>
                            <p className="text-muted-foreground mt-3 text-balance">Your codes are private. You're in full control</p>
